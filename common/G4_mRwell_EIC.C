...
namespace RWELL
{
  ...
  double e_length_uRwell[RWELL::n_layer] =  {40.08, 106., 290/2.};
  double h_length_uRwell[RWELL::n_layer] = {e_length_uRwell[0], e_length_uRwell[1], 290/2.};
  const double nom_driftgap[RWELL::n_layer] = {0.4, 0.4, 0.4};
  //const double nom_length[RWELL::n_layer] = {140, 150, 280.0};
  const double nom_length[RWELL::n_layer] = {2*e_length_uRwell[0], 2*e_length_uRwell[1], 280.0};
  int subsysID = 0;
}  //namespace RWELL
