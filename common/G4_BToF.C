...
namespace BTOF
{
  ...
  const double length =  300.; //cm  
}

void BToFInit(int verbosity =0 )
{
		     ...
		     )
{
  ...
  for(int layer = 0 ; layer < BTOF::gas_lyr ;  layer++ ) {
    ...
    g4Reco->registerSubsystem(tof_cyl);
    tof_cyl->OverlapCheck(OverlapCheck);
    cout << " gas inner" << layer << " :  " << rsum_gasin << endl;
    ...
    if(layer < BTOF::mrpc_inn_lyr ) {
      ...
      g4Reco->registerSubsystem(tof_cyl);
      tof_cyl->OverlapCheck(OverlapCheck);
      cout << " inner mrpc" << layer << " :  " << rsum_innglass << endl;
    }
    //cout << " inner mrpc" << layer << " :  " << rsum_innglass << endl;
  ...
  g4Reco->registerSubsystem(tof_cyl);
  tof_cyl->OverlapCheck(OverlapCheck);
  cout << " mid bottom glass  :" << rsum << endl;
  ...
  g4Reco->registerSubsystem(tof_cyl);
  tof_cyl->OverlapCheck(OverlapCheck);
  cout << " mid bottom Carbon :" << rsum << endl;
  ...
  g4Reco->registerSubsystem(tof_cyl);
  tof_cyl->OverlapCheck(OverlapCheck);
  cout << " Mid bottom Mylar : " << rsum << endl;
  ...
  g4Reco->registerSubsystem(tof_cyl);
  tof_cyl->OverlapCheck(OverlapCheck);
  cout << " mid PCB bottom cu :" <<  rsum << endl;
  ...
  for(int layer = 0 ; layer < BTOF::gas_lyr ;  layer++ ) {
    ...
    g4Reco->registerSubsystem(tof_cyl);
    tof_cyl->OverlapCheck(OverlapCheck);
    cout << " gas inner" << layer << " :  " << rsum_gasin_uphalf << endl;
    ...
    if(layer < BTOF::mrpc_inn_lyr ) {
      ...
      g4Reco->registerSubsystem(tof_cyl);
      tof_cyl->OverlapCheck(OverlapCheck);
      cout << " inner mrpc" << layer << " :  " << rsum_innglass_uphalf << endl;
    }
  ...
  g4Reco->registerSubsystem(tof_cyl);
  tof_cyl->OverlapCheck(OverlapCheck);
  cout << " Top honeycomb :" << rsum << endl;
   

  return tof_rad;
  cout << " tof thickness :" << tof_rad << endl;
