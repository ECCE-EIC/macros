...
bool OverlapCheck = Enable::OVERLAPCHECK || Enable::ETOF_OVERLAPCHECK;
 ...
 g4Reco->registerSubsystem(eTOF);
  ...
  cout << " ETOF gas layer  :" << ETOF::f_gas_lyr << endl;
   ...
   if (TRACKING::FastKalmanFilter)
    ...
    //Reference plane projection at initial R of ToF 
       TRACKING::FastKalmanFilter-> add_zplane_state(string("G4HIT_") + string(Form("ACTIVEGAS_TOF")) , HTOF::z_start);
       TRACKING::ProjectionNames.insert(string("G4HIT_") + string(Form("ACTIVEGAS_TOF")));
