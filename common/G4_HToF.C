...
bool OverlapCheck = Enable::OVERLAPCHECK || Enable::HTOF_OVERLAPCHECK;
 ...
 g4Reco->registerSubsystem(hTOF);
  ...
  cout << " HTOF gas layer  :" << HTOF::f_gas_lyr << endl;
   ...
   if (TRACKING::FastKalmanFilter)
     {
       ...
       */
       ...
       TRACKING::FastKalmanFilter-> add_zplane_state(string("G4HIT_") + string(Form("ACTIVEGAS_TOF")) , HTOF::z_end);
